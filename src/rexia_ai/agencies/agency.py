...
class ManagerAgent:
            ...
            try:
                while True:
                    ...
                    try:
                        ...
                        print(
                            f"Error executing assignment: {str(e)}. Skipping this assignment and continuing..."
                        )
                        self.collaboration_channel.put(
                            f"Assignment for {next_action['assignment'].name} failed: {str(e)}"
                        )
                return
    ...
    def present_results(self) -> str:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                cleaned_report = self._clean_response(report)
    ...
    def _get_next_action(self) -> Dict[str, Any]:
        ...
        while attempt < self.max_retries:
            try:
                ...
                error_prompt = f"""Your previous generation contained incorrectly formatted JSON. Please fix this and any other errors,
    ...
    def _execute_assignment(self, assignment: AgentAssignment) -> None:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                self.collaboration_channel.put(result_summary)
                return
            except Exception as e:
                if attempt < self.max_retries - 1:
                    print(f"Attempt {attempt + 1} failed: {str(e)}. Retrying...")
    ...
    def _clean_response(self, response: str) -> str:
        ...
        """
        cleaned_response = Utility.remove_system_tokens(response)
